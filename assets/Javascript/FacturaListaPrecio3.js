...
$(document).off('keydown.facturalistaprecio').on('keydown.facturalistaprecio', function (e) {
            ...
            if (index == 0) {
                ...
                if (index == obj.length) {
                    ...
                    if ((index + 1) % 4 != 0) {
                        ...
                        else div_string = div_string + "<div class='col-md-3 favoritos' style='padding-left: 0px; padding-right: 3.5px;'><div oncontextmenu='clickfavoritos(this.id," + obj[index].bprefer + ")' id='" + obj[index].id_articulo + "'style='border: ridge;background-color: white;height: 150px;padding: 0px;' onclick='PasarArticulo(this.id)'><article style='text-align: -webkit-center;height: 110px;'><h1><a class='precio' title=''>" + obj[index].precio + "</a></h1><img style='height: initial;width: initial;max-width: -webkit-fill-available;max-height: -webkit-fill-available;' src='" + imgSrc + "' height='50' alt=''/></article><p class='cuadrado_desc' style='text-align: -webkit-center;line-height: normal;'>" + obj[index].cdsc_articulo + "</p></div></div>";
                    }
                    else {
...
$(document).off('keyup.facturalistaprecio_suggest').on('keyup.facturalistaprecio_suggest', function(e) {
  if (e.keyCode === 27) {
    $("#sugerencias_clientes").html("");
    $("#sugerencias_clientes").hide();
  }

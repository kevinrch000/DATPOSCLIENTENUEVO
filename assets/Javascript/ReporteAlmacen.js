...
function Ejecutar() {
    ...
    $.ajax({
        type: "POST",
        url: 'ReporteAlmacen.aspx/ReporteAlmacenPrincipal',
        data: JSON.stringify({ ReportAlmacen: obj }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (response) {
            if (typeof window.DATPOS_spaNavigate === 'function') {
                window.DATPOS_spaNavigate((window.DATPOS_BASE_PATH||'')+'/pages/Reportes/InformeAlmacen.php');
            } else {
                window.location.href = (window.DATPOS_BASE_PATH||'')+'/pages/Reportes/InformeAlmacen.php';
            }
        },
...
function ModalConsultarArticulos() {
    ...
    var obj = llenarobjeto('ReporteAlmacen.aspx/CargarArticulo');
...
$(document).ready(function () {
    ...
    inicar_menu_nivel3('Reporte de Almacen', '1_li_Almacen', '2_li_ReporteAlmacen', '3_li_ReporteAlmacen', '0');

    ...
    $.ajax({
        ...
        success: function (response) { 
            if (typeof window.DATPOS_spaNavigate === 'function') {
                window.DATPOS_spaNavigate((window.DATPOS_BASE_PATH||'')+'/pages/Reportes/InformeSaldo.php');
            } else {
                window.location.href = (window.DATPOS_BASE_PATH||'')+'/pages/Reportes/InformeSaldo.php';
            }
        },

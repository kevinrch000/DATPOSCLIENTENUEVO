...
function Ejecutar() { 
    ...
    $.ajax({
        type: "POST",
        url: 'ReporteKardex.aspx/ReporteKardexPrincipal',
        data: JSON.stringify({ 
            ReporteKardex: objKardex
        }),
        ...
        success: function (response) { 
            if (typeof window.DATPOS_spaNavigate === 'function') {
                window.DATPOS_spaNavigate((window.DATPOS_BASE_PATH||'')+'/pages/Reportes/InformeKardex.php');
            } else {
                window.location.href = (window.DATPOS_BASE_PATH||'')+'/pages/Reportes/InformeKardex.php';
            }
        },
...
$(document).ready(function () {
   ...
   inicar_menu_nivel3('Reporte de Kardex', '1_li_Almacen', '2_li_ReporteAlmacen', '3_li_ReporteKardex', '0');
    $('#btn_p_nuevo').hide();
    $('#btn_p_editar').hide();
    $('#btn_p_grabar').hide();
    $('#btn_p_eliminar').hide();

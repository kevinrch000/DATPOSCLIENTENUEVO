...
if ( 0 == CantFilaTablaNumeradores) {
    $dropdown.append($("<option />").val("I").text("Ingreso"));
    $dropdown.append($("<option />").val("S").text("Salida"));
}else if ( 0 < CantFilaTablaNumeradores) {

if(document.getElementById("tablanumerador").rows[1].cells[0].innerHTML=="I"){          
    $dropdown.append($("<option />").val("S").text("Salida"));
}else if(document.getElementById("tablanumerador").rows[1].cells[0].innerHTML=="S"){
    $dropdown.append($("<option />").val("I").text("Ingreso"));
}
} 
    $("#tb_tipDoc").val("");

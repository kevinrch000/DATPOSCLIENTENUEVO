...
-- Admin hijos directos (nivel 2, corden = valor del VB)
...
-- NIVEL 3 (corden > 1000, coinciden con VB donde es posible)
-- ALMACEN > TABLAS
INSERT INTO Menus (ccod_empresa,cdsc_menu,curl_href,curl_src,nid_menupadre,cli_menu,cul_menu,nivel,corden,cstatus) VALUES
...
-- NotaDebito.aspx.vb verifica 25, menú tiene 1036
INSERT INTO Accesos (ccod_empresa,id_rol,corden,cstatus) VALUES('EMP01',@rol,25,'1');
-- ConsultasVenta.aspx.vb verifica 30, menú tiene 1040
INSERT INTO Accesos (ccod_empresa,id_rol,corden,cstatus) VALUES('EMP01',@rol,30,'1');
-- ConsultaListPrecio.aspx.vb verifica 39, menú tiene 1041
INSERT INTO Accesos (ccod_empresa,id_rol,corden,cstatus) VALUES('EMP01',@rol,39,'1');
-- Kardex.aspx.vb verifica 42, menú tiene 1042
INSERT INTO Accesos (ccod_empresa,id_rol,corden,cstatus) VALUES('EMP01',@rol,42,'1');
-- ReporteKardex.aspx.vb verifica 43, menú tiene 1043
INSERT INTO Accesos (ccod_empresa,id_rol,corden,cstatus) VALUES('EMP01',@rol,43,'1');
GO

SELECT COUNT(*) AS total_menus FROM Menus;
SELECT COUNT(*) AS total_accesos FROM Accesos;
GO
PRINT '✓ Menú definitivo con accesos correctos.';
GO

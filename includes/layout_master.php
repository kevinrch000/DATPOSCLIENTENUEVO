        ...
        <div id="spa-content-area">
            ...
            <div id="spa-crud-buttons" style="<?= $showCrudButtons ? '' : 'display:none;' ?>">
                <div class="adminActions content">
                    <div class="adminButtons">
                        ...
                        <div class="botonesnuevos">
                            <a href="javascript:void(0);" class="botones_des" id="btn_p_grabar" style="background-color: #5cb85c;" title="Grabar"
                                onclick="Guardar();">
                                <i class="material-icons">save</i>
                            </a>
                        </div>
                        <div class="botonesnuevos">
                            <a href="javascript:void(0);" class="botones_des" id="btn_p_eliminar" style="background-color: #f44336;"
                                title="Eliminar" onclick="Eliminar();">
                                <i class="material-icons">delete</i>
                            </a>
                        </div>
                        <div class="botonesnuevos">
                            <a href="javascript:void(0);" class="botones_des" id="btn_p_back"
                                style="background-color: #727292;" title="Deshacer" onclick="Deshacer();">
                                <i class="material-icons">undo</i>
                            </a>
                        </div>
                        <div class="botonesnuevos">
                            <a href="javascript:void(0);" class="botones_des" id="btn_p_imprimir"
            ...
            <div id="spa-consult-buttons" style="<?= $showConsultButtons ? '' : 'display:none;' ?>">
                <div id="divColsulta" class="adminActions content" style="visibility:hidden;">
                    <div class="adminButtons">
                        <div class="botonesnuevos">
                            <a href="javascript:void(0);" class="botones_des" id="btn_p_ejecutar" style="background-color: #f0ad4e;"
                                title="Ejecutar" onclick="Ejecutar();">
                                <i class="material-icons">play_arrow</i>
                            </a>
                        </div>
                        <div class="botonesnuevos">
                            <a href="javascript:void(0);" class="botones_hab" id="btn_p_excel" style="background-color: #27ae60;"
                                title="Exportar a Excel" onclick="exportarExcelGrid();">
                                <i class="material-icons">file_download</i>
                            </a>
                        </div>
                        <div class="botonesnuevos">
                            <a href="javascript:void(0);" class="botones_des" id="btn_p_limpiar" style="background-color: #21b5d6;"

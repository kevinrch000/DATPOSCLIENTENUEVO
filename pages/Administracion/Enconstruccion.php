...
<!DOCTYPE html><html><head><meta charset="utf-8"><title>En Construcción | DATPOS</title>
...
h2{color:#ff9800}a{display:inline-block;margin-top:15px;padding:10px 30px;background:#046bb4;color:#fff;border-radius:25px;text-decoration:none}</style></head>
<body><div class="box"><h2><i class="fa fa-cogs"></i> En Construcción</h2><p style="color:#666">Este módulo está en proceso de implementación.</p>

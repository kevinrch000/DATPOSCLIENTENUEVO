...
$pageTitle = 'Reporte Almacén | DATPOS'; $pageScript = 'ReporteAlmacen.js'; $showCrudButtons = false; $showConsultButtons = true;
ob_start(); ?>
<input id="operacion" type="hidden" />
    ...
    <label id="lbCodTienda" style="display:none;" ><?= e(getUsuarioSesion()->ccod_tiend ?? '') ?></label>
    ...
    <div class="c-content-center modern-page" style="padding-top:40px;"  >
      ...
      <!-- DATOS --> 
            ...
            <div class="row">
                ...
                <div class="col-sm-4" style="padding-top: 10px;">
                    <span class="has-float-label">
                        <input id="txtfchDesde" maxlength="10" type="text" class="limpiar form-control moderno_tb" onclick="ObtenerNombreColumna(this)"
                            placeholder=" " />
               ...
               <div class="col-sm-4" style="padding-top: 10px;">
                    <span class="has-float-label">
                        <input id="txtfchHasta" maxlength="10" type="text" class="limpiar form-control moderno_tb" onclick="ObtenerNombreColumna(this)"
                            placeholder=" " />
            ...
            <div class="row" style="padding-bottom: 30px;">
                  <div class="col-sm-4" style="padding-top: 10px;">
                      <div class="floating-label">   
                       <select class="floating-select"  onclick="this.setAttribute('value', this.value);ObtenerNombreColumna(this);" value=""  id="txtTipoOperacion"  ></select> 
                        <label class="floating-select2">Código Operación</label> 
                      </div>  
                </div>
                <div class="col-sm-4" style="padding-top:10px;display:none;" >
                    <div class="input-group">
                    <span  class="has-float-label"   >
                    <input id="txtCodArticulo"   maxlength="15" type="text" class="limpiar form-control moderno_tb" placeholder=" " onclick="ObtenerNombreColumna(this);" /> 

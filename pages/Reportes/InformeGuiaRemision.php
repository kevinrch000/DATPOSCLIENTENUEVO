...
$pageTitle = 'Informe Guía Remisión | DATPOS'; $pageScript = ''; $showCrudButtons = false;
ob_start(); ?>
<div class="c-content-center modern-page" style="padding:20px;">
    <h4 style="border-bottom:groove;margin-bottom:20px;">Informe de Guía de Remisión</h4>

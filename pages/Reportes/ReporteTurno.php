...
$pageTitle = 'Reporte Turno | DATPOS'; $pageScript = 'ReporteTurno.js'; $showCrudButtons = false; $showConsultButtons = true;
ob_start(); ?>
    ...
    <div class="c-content-center modern-page" style="padding-top:40px;"  >
      ...
      <!-- DATOS --> 
            ...
            <div class="row">
                <div class="col-sm-4" style="padding-top: 10px;">
                      <div class="floating-label">   
                       <select class="floating-select"   onclick="this.setAttribute('value', this.value);ObtenerNombreColumna(this);" onchange="CargarUsuario()"  value=""   id="txtTienda"  ></select> 
            ...
            <div class="row" style="padding-bottom: 30px;">
                <div class="col-sm-4" style="padding-top: 10px;">
                      <div class="floating-label">   
                       <select class="floating-select"   onclick="this.setAttribute('value', this.value);ObtenerNombreColumna(this);"  value=""   id="txtUsuario"  ></select> 
                        <label class="floating-select2">Usuario</label> 
                      </div>  
                </div> 
            </div>

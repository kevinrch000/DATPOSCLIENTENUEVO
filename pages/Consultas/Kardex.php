...
$pageTitle = 'Kardex | DATPOS'; $pageScript = 'Kardex.js'; $showCrudButtons = false; $showConsultButtons = true;
ob_start(); ?>
      ...
      <!-- DATOS -->
            ...
            <div class="row">
                <div class="col-sm-4" style="padding-top: 10px;">
                      <div class="floating-label">  
                       ...
                       <select class="floating-select"  onclick="this.setAttribute('value', this.value);" value=""  id="txtTienda"  ></select> 
                        <label class="floating-select2">Tienda*</label> 
                      </div>  
                </div>
                <div class="col-sm-4" style="padding-top: 10px;">
                <div class="floating-label">  
                       <select class="floating-select"  onclick="this.setAttribute('value', this.value);" value=""  id="txtAlmacen"  ></select> 
            ...
            <div class="row" style="padding-bottom: 30px;">
                <div class="col-sm-4" style="padding-top: 10px;display:none;">
                    <span class="has-float-label">
                        <input id="txtNomAticulo" maxlength="100" type="text" class="limpiar form-control moderno_tb"
                            placeholder=" " />
                        <label for="txtNomAticulo">
                            Nombre de Artículo</label>
                    </span>
                </div>

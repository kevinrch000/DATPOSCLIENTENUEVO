...
$pageTitle = 'Consulta Almacén | DATPOS'; $pageScript = 'ConsultaAlmacen.js'; $showCrudButtons = false; $showConsultButtons = true;
ob_start(); ?>
            ...
            <div id="Datos" class="tab-pane in active ">
                ...
                <ul class="nav nav-tabs" class="active">
                    ...
                    <li onclick=""><a data-toggle="tab" href="#Estadisticas" class="tabcito" style="color: #228ac9;
                        font-size: 17px;">Datos Adicionales</a></li>
                </ul>
                ...
                <div class="tab-content" style="padding-bottom: 30px;">
                    ...
                    <div id="Estadisticas" class="tab-pane tabcito" style="padding: 13px;">
                       ...
                       <div class="col-sm-4" style="padding-top: 10px;">
                           <span class="has-float-label">
                               <input id="txtCantArt" disabled type="text" class="limpiar form-control moderno_tb"
                                   placeholder=" " onclick="ObtenerNombreColumna(this)" />
                               <label for="txtCantArt">
                                   Cantidad de Articulos</label>
                           </span>
                       </div>
                       <div class="col-sm-4" style="padding-top: 10px;">
                           <span class="has-float-label">
                               <input id="txtImpTot" disabled type="text" class="limpiar form-control moderno_tb"
                                   placeholder=" " onclick="ObtenerNombreColumna(this)" />
                               <label for="txtImpTot">
                                   Importe Total</label>
                           </span>

...
<div class="c-content-center modern-page">
    <div class="modern-page-header">
        ...
        <div class="mph-text">
            ...
            <p>Busca artículos por familia, unidad de medida, tipo, tributos y estado.</p>
        </div>
    ...
    <div class="dp-filters" style="margin-bottom:16px;">
        ...
        <div class="dp-filter">
            <label for="slUniMedida">Unidad de Medida</label>
            <select class="form-control moderno_tb" id="slUniMedida" onclick="this.setAttribute('value', this.value);ObtenerNombreColumna(this);"></select>
        </div>
        <div class="dp-filter">
            <label for="slTipArticulo">Tipo Artículo</label>
            <select class="form-control moderno_tb" id="slTipArticulo" onclick="this.setAttribute('value', this.value);ObtenerNombreColumna(this);">
        ...
        <div class="dp-filter">
            <label for="slTributos">Tributos</label>
            <select class="form-control moderno_tb" id="slTributos" onclick="this.setAttribute('value', this.value);ObtenerNombreColumna(this);">
                <option value="%%%">Todos</option>
        ...
        <div class="dp-filter">
            ...
            <select class="form-control moderno_tb" id="slEstado" onclick="this.setAttribute('value', this.value);ObtenerNombreColumna(this);">
                <option value="%%%">Todos</option>
        ...
        <div class="dp-filter">
            ...
            <div class="input-group">
                ...
                <a class="disabled input-group-addon" data-toggle="modal" data-target="#modalConsultarArticulos" onclick="ModalConsultarArticulos();" style="background-color:#fff;border:0;">
                    <i class="fa fa-search color-buscadores"></i>
                </a>
            </div>
        </div>
    </div>
    <!-- campo oculto para compatibilidad con el JS original -->
    <input id="txtNomAticulo" maxlength="100" type="text" class="limpiar form-control moderno_tb" style="display:none;" onclick="ObtenerNombreColumna(this)"/>

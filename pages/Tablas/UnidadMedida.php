    ...
    <div class="tab-content">
        ...
        <div id="Datos" class="tab-pane in active" style="padding: 13px;">
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-sm-6 col-xs-12">
                    <label class="col-sm-2 moderno_lb">Etiqueta*</label>
                    <div class="col-sm-10">
            ...
            <div class="row" style="margin-top: 20px;">
                <div class="col-sm-6 col-xs-12">
                    <label class="col-sm-2 moderno_lb">Código Unidad Medida Sunat*</label>
                    <div class="col-sm-10">
                ...
                <div class="col-sm-6 col-xs-12">
                    <label class="col-sm-2 moderno_lb">Descripción*</label>
                    <div class="col-sm-10">
        ...
        <div id="Lista" class="tab-pane tabcito" style="padding: 13px;">
            ...
            <table id="table_id" class="display" style="width:100%;">
                ...
                <thead id="thTablaUnidadMedida">
                    <tr>
                        <th></th><th>Código</th><th>Etiqueta</th>
